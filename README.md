...
To reduce database round-trips, the ADM data records are processed and inserted
in **n-batches**. You can configure the batch size using `--queue-batch-size` to
balance memory usage and insertion speed.
...
contribute to a better **base input data** for the project.
