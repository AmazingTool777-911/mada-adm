                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <p class="flex items-center gap-x-1">
                        <span class="badge badge-soft badge-info">string</span>
                        |
                    ...
                    <td>
                      <p class="text-sm text-base-content/80">
                        ...
                        <strong>original names</strong>. The current ADM tables
                        are: {actualTableNames.map((t) => (
                          <>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <span
                        class={`badge badge-soft ${
                          config.isFkRepeated ? "badge-success" : "badge-error"
                        }`}
                      >
                    ...
                    <td>
                      <p class="text-sm text-base-content/80">
                        ...
                        {" "}
                        of the{" "}
                        <strong>direct parent ADM table</strong>. Otherwise, if
                        {" "}
                        <span class="badge-sm badge badge-success badge-soft">
                          true
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="text-sm text-base-content/80">
                        ...
                        <span class="badge-sm badge badge-success badge-soft">
                          true
                        </span>, <strong>all the ADM tables</strong> include the
                        {" "}
                        <strong>province</strong> name. Otherwise, if{" "}
                        <span class="badge-sm badge badge-error badge-soft">
                          false
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="text-sm text-base-content/80">
                        ...
                        <strong>all the ADM tables below the provinces</strong>
                        {" "}
                        table include{" "}
                        <strong>province id foreign keys</strong>. Otherwise, if
                        {" "}
                        <span class="badge-sm badge badge-error badge-soft">
                          false
                  ...
                  <tr>
                    ...
                    <td>
                      <p class="text-sm text-base-content/80">
                        ...
                        starting from the province level to the fokontany level.
                      </p>
                    </td>
                  </tr>
                </tbody>
